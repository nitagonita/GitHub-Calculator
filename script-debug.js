// ===================================================================
// DEBUG VERSION - calculator-debug.js
// ===================================================================
...
updateDisplay(0);
console.log("✅ Calculator initialized, display =", getDisplay());
...
function handleNumber(digit) {
  ...
  console.log("[NUMBER] before =", current, "digit =", digit, "reset =", shouldResetDisplay);
  ...
  console.log("[NUMBER] after =", getDisplay());
}

function handleDecimal() {
  const current = normalizeNumberString(getDisplay());
  console.log("[DECIMAL] before =", current, "reset =", shouldResetDisplay);
  ...
  console.log("[DECIMAL] after =", getDisplay());
}

// ===================== Operator & Execute =====================
function handleOperator(op) {
  const currentValue = toNumberFromDisplay(getDisplay());
  console.log("[OPERATOR] pressed =", op, "current =", currentValue, "firstOperand =", firstOperand, "prevOp =", operator);
...
function executeOperation() {
  ...
  console.log("[EXEC] first =", firstOperand, "op =", operator, "second =", secondOperand);
